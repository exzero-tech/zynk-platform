    ...
    <div className="bg-foreground rounded-2xl p-0 flex flex-col items-center justify-center h-24">
      <div className="relative">
        ...
        <svg width="170" height="100" viewBox="0 0 80 40" fill="none" xmlns="http://www.w3.org/2000/svg" >
          {/* Range text */}
          <text x="8" y="9" textAnchor="start" fill="var(--text-secondary)" fontSize="7">Left 120 KM</text>
          {/* Battery body */}
          ...
          {/* Percentage text */}
          <text x="35" y="23" textAnchor="middle" dominantBaseline="middle" fill="white" fontSize="9" fontWeight="bold">{charge}%</text>
        </svg>
      </div>
    </div>
  )
